...
class ApplicationTestCase(unittest.TestCase):
    ...
    def test_managed_file_can_be_opened_in_preview(self) -> None:
        ...
        self.assertIn('data-frame-stepping', body)
    ...
    def test_library_preview_action_keeps_full_player_behaviour(self) -> None:
        ...
        self.assertIn('item.addEventListener("contextmenu"', script)
        self.assertIn('menu.classList.add("library-menu-context-open")', script)
        self.assertIn('menuPanel.querySelector("a, button")?.focus', script)
        ...
        self.assertIn('t("js.previous_frame")', script)
        self.assertIn('t("js.next_frame")', script)
        self.assertIn('stepFrame(-1)', script)
        self.assertIn('stepFrame(1)', script)
        self.assertIn('seekBy(direction / 30)', script)
        self.assertIn('player.hasAttribute("data-frame-stepping")', script)
        ...
        self.assertIn("media.playbackRate = 1", script)
        self.assertIn("button.dataset.playbackRate = String(rate)", script)
        self.assertIn('button.addEventListener("click"', script)
        self.assertNotIn("playbackRate: clampPlaybackRate(settings.playbackRate)", script)
        self.assertNotIn("playbackRate: media.playbackRate", script)
        ...
        self.assertIn(".custom-player-main-row", style)
